...
- Reviewing more than one plan per invocation, **unless** the human opted
  into `--batch [N]` for this invocation (see "Batch mode") — every item in
  a batch still gets its own full pipeline and its own required survey
